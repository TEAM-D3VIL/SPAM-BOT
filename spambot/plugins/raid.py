...
@D3vilBot1.on(events.NewMessage(incoming=True, pattern='/mraid'))
@D3vilBot2.on(events.NewMessage(incoming=True, pattern='/mraid'))
@D3vilBot3.on(events.NewMessage(incoming=True, pattern='/mraid'))
@D3vilBot4.on(events.NewMessage(incoming=True, pattern='/mraid'))
@D3vilBot5.on(events.NewMessage(incoming=True, pattern='/mraid'))
async def mraid(e):
    if e.sender_id in MY_USERS:
        name = e.sender.first_name
        user_id = e.sender_id
        mention = f"[{name}](tg://user?id={user_id})"
        me = await D3vilBot1.get_me()
        global myraid
...
@D3vilBot1.on(events.NewMessage(incoming=True, pattern='/sraid'))
@D3vilBot2.on(events.NewMessage(incoming=True, pattern='/sraid'))
@D3vilBot3.on(events.NewMessage(incoming=True, pattern='/sraid'))
@D3vilBot4.on(events.NewMessage(incoming=True, pattern='/sraid'))
@D3vilBot5.on(events.NewMessage(incoming=True, pattern='/sraid'))
async def sraid(e):
    if e.sender_id in MY_USERS:
        global myraid
        if e.is_reply is True:
...
@D3vilBot1.on(events.NewMessage(incoming=True, pattern='/raid'))
@D3vilBot2.on(events.NewMessage(incoming=True, pattern='/raid'))
@D3vilBot3.on(events.NewMessage(incoming=True, pattern='/raid'))
@D3vilBot4.on(events.NewMessage(incoming=True, pattern='/raid'))
@D3vilBot5.on(events.NewMessage(incoming=True, pattern='/raid'))
async def raid(e):
    if e.sender_id in MY_USERS:
        global fraid
        fraid = True
...
@D3vilBot1.on(events.NewMessage(incoming=True, pattern='/draid'))
@D3vilBot2.on(events.NewMessage(incoming=True, pattern='/draid'))
@D3vilBot3.on(events.NewMessage(incoming=True, pattern='/draid'))
@D3vilBot4.on(events.NewMessage(incoming=True, pattern='/draid'))
@D3vilBot5.on(events.NewMessage(incoming=True, pattern='/draid'))
async def draid(e):
    if e.sender_id in MY_USERS:
        global fraid
        fraid = False
