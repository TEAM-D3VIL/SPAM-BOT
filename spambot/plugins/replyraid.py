...
@D3vilBot1.on(events.NewMessage(incoming=True, pattern='/replyraid'))
@D3vilBot2.on(events.NewMessage(incoming=True, pattern='/replyraid'))
@D3vilBot3.on(events.NewMessage(incoming=True, pattern='/replyraid'))
@D3vilBot4.on(events.NewMessage(incoming=True, pattern='/replyraid'))
@D3vilBot5.on(events.NewMessage(incoming=True, pattern='/replyraid'))
...
@D3vilBot1.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
@D3vilBot2.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
@D3vilBot3.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
@D3vilBot4.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
@D3vilBot5.on(events.NewMessage(incoming=True, pattern='/dreplyraid'))
...
@D3vilBot1.on(events.NewMessage(incoming=True))
@D3vilBot2.on(events.NewMessage(incoming=True))
@D3vilBot3.on(events.NewMessage(incoming=True))
@D3vilBot4.on(events.NewMessage(incoming=True))
@D3vilBot5.on(events.NewMessage(incoming=True))
async def fuck(e):
    global enemy
