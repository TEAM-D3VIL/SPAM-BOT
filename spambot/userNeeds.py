import os
from spambot import *
from spambot import D3vilBot1
from pathlib import Path
from telethon import events
from spambot.__main__ import load_plugs


@D3vilBot1.on(events.NewMessage(incoming=True, pattern="/install"))
async def install(e):
...
@D3vilBot1.on(events.NewMessage(incoming=True, pattern="/uninstall"))
